  ...
  describe LocalEvaluationClient do
    ...
    describe '#evaluation' do
      ...
      it 'evaluation should return specific variants' do
        ...
        response = '[{"allUsersTargetingConfig":{"allocations":[{"percentage":10000,"weights":{"on":1}}],"bucketingKey":"device_id","conditions":[],"name":"default-segment"},"bucketingKey":"device_id","bucketingSalt":"52vuIAwB","customSegmentTargetingConfigs":[],"defaultValue":"off","enabled":true,"evalMode":"LOCAL","flagKey":"asdf-1","flagName":"asdf","flagVersion":7,"globalHoldbackBucketingKey":"amplitude_id","globalHoldbackPct":0,"globalHoldbackSalt":null,"mutualExclusionConfig":null,"type":"RELEASE","useStickyBucketing":false,"userProperty":"[Experiment] asdf-1","variants":[{"key":"on","payload":null}],"variantsExclusions":null,"variantsInclusions":{}},{"allUsersTargetingConfig":{"allocations":[{"percentage":0,"weights":{"control":1,"treatment":1}}],"bucketingKey":"device_id","conditions":[],"name":"default-segment"},"bucketingKey":"device_id","bucketingSalt":"fLH7KClm","customSegmentTargetingConfigs":[{"allocations":[{"percentage":0,"weights":{"control":1,"treatment":0}}],"bucketingKey":"device_id","conditions":[{"op":"IS","prop":"gp:bucket","values":["device_id"]}],"name":"Segment 1"},{"allocations":[{"percentage":10000,"weights":{"control":0,"treatment":1}}],"bucketingKey":"user_id","conditions":[{"op":"IS","prop":"gp:bucket","values":["user_id"]}],"name":"Segment 2"}],"defaultValue":"off","enabled":true,"evalMode":"LOCAL","flagKey":"local-test-3","flagName":"local-test-3","flagVersion":11,"globalHoldbackBucketingKey":"amplitude_id","globalHoldbackPct":0,"globalHoldbackSalt":null,"mutualExclusionConfig":null,"type":"RELEASE","useStickyBucketing":false,"userProperty":"[Experiment] local-test-3","variants":[{"key":"control","payload":null},{"key":"treatment","payload":null}],"variantsExclusions":null,"variantsInclusions":{}},{"allUsersTargetingConfig":{"allocations":[{"percentage":10000,"weights":{"control":1,"treatment":1}}],"bucketingKey":"device_id","conditions":[],"name":"default-segment"},"bucketingKey":"device_id","bucketingSalt":"DdqDXcww","customSegmentTargetingConfigs":[{"allocations":[{"percentage":0,"weights":{"control":1,"treatment":1}}],"bucketingKey":"device_id","conditions":[{"op":"IS","prop":"gp:premium","values":["true"]}],"name":"Segment 1"}],"defaultValue":"off","enabled":true,"evalMode":"LOCAL","flagKey":"local-evaluation-demo","flagName":"local-evaluation-demo","flagVersion":4,"globalHoldbackBucketingKey":"amplitude_id","globalHoldbackPct":0,"globalHoldbackSalt":null,"mutualExclusionConfig":null,"type":"EXPERIMENT","useStickyBucketing":false,"userProperty":"[Experiment] local-evaluation-demo","variants":[{"key":"control","payload":null},{"key":"treatment","payload":null}],"variantsExclusions":null,"variantsInclusions":{}},{"allUsersTargetingConfig":{"allocations":[{"percentage":10000,"weights":{"control":0,"treatment":1}}],"bucketingKey":"device_id","conditions":[],"name":"default-segment"},"bucketingKey":"device_id","bucketingSalt":"JIMMrZ3N","customSegmentTargetingConfigs":[],"defaultValue":"off","enabled":true,"evalMode":"LOCAL","flagKey":"join-loyalty-program","flagName":"join-loyalty-program","flagVersion":17,"globalHoldbackBucketingKey":"amplitude_id","globalHoldbackPct":0,"globalHoldbackSalt":null,"mutualExclusionConfig":null,"type":"RELEASE","useStickyBucketing":false,"userProperty":"[Experiment] join-loyalty-program","variants":[{"key":"control","payload":null},{"key":"treatment","payload":{"feed_name":"FeedPromote_ROW_B"}}],"variantsExclusions":null,"variantsInclusions":{"treatment":["brian@amplitude.com"]}}]'
